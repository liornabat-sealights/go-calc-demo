...
func setup(shutdown chan struct{}) {__sealights__.TraceFunc("d1334dab5a7a38cb6a");
...
func main() {__sealights__.StartMainFunc("7084e712c6351d4e37");defer func() { __sealights__.EndMainFunc("7084e712c6351d4e37")}();
